...
public static class BurstClassInfo
{
	...
	internal unsafe delegate int Index_0000471C_0024PostfixBurstDelegate(lua_State* L);

	internal static class Index_0000471C_0024BurstDirectCall
	{
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<Index_0000471C_0024PostfixBurstDelegate>(Index).Value;
			}
			P_0 = Pointer;
		}
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal unsafe delegate int NewIndex_0000471D_0024PostfixBurstDelegate(lua_State* L);

	internal static class NewIndex_0000471D_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<NewIndex_0000471D_0024PostfixBurstDelegate>(NewIndex).Value;
			}
			P_0 = Pointer;
		}
	...
	[UnmanagedFunctionPointer(CallingConvention.Cdecl)]
	internal unsafe delegate int NameCall_0000471E_0024PostfixBurstDelegate(lua_State* L);

	internal static class NameCall_0000471E_0024BurstDirectCall
	{
		private static IntPtr Pointer;
		...
		private unsafe static void GetFunctionPointerDiscard(ref IntPtr P_0)
		{
			if (Pointer == (IntPtr)0)
			{
				Pointer = BurstCompiler.CompileFunctionPointer<NameCall_0000471E_0024PostfixBurstDelegate>(NameCall).Value;
			}
			P_0 = Pointer;
		}
	...
	[BurstCompile]
	[MonoPInvokeCallback(typeof(Index_0000471C_0024PostfixBurstDelegate))]
	public unsafe static int Index(lua_State* L)
	{
		return Index_0000471C_0024BurstDirectCall.Invoke(L);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(NewIndex_0000471D_0024PostfixBurstDelegate))]
	public unsafe static int NewIndex(lua_State* L)
	{
		return NewIndex_0000471D_0024BurstDirectCall.Invoke(L);
	}

	[BurstCompile]
	[MonoPInvokeCallback(typeof(NameCall_0000471E_0024PostfixBurstDelegate))]
	public unsafe static int NameCall(lua_State* L)
	{
		return NameCall_0000471E_0024BurstDirectCall.Invoke(L);
	}
