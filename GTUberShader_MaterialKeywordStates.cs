...
public struct GTUberShader_MaterialKeywordStates
{
	...
	{
		material = mat;
		STEREO_INSTANCING_ON = mat.IsKeywordEnabled("STEREO_INSTANCING_ON");
		UNITY_SINGLE_PASS_STEREO = mat.IsKeywordEnabled("UNITY_SINGLE_PASS_STEREO");
		STEREO_MULTIVIEW_ON = mat.IsKeywordEnabled("STEREO_MULTIVIEW_ON");
		STEREO_CUBEMAP_RENDER_ON = mat.IsKeywordEnabled("STEREO_CUBEMAP_RENDER_ON");
		_GLOBAL_ZONE_LIQUID_TYPE__WATER = mat.IsKeywordEnabled("_GLOBAL_ZONE_LIQUID_TYPE__WATER");
		_GLOBAL_ZONE_LIQUID_TYPE__LAVA = mat.IsKeywordEnabled("_GLOBAL_ZONE_LIQUID_TYPE__LAVA");
		_ZONE_LIQUID_SHAPE__CYLINDER = mat.IsKeywordEnabled("_ZONE_LIQUID_SHAPE__CYLINDER");
		_ZONE_DYNAMIC_LIGHTS__CUSTOMVERTEX = mat.IsKeywordEnabled("_ZONE_DYNAMIC_LIGHTS__CUSTOMVERTEX");
		_USE_TEXTURE = mat.IsKeywordEnabled("_USE_TEXTURE");
		USE_TEXTURE__AS_MASK = mat.IsKeywordEnabled("USE_TEXTURE__AS_MASK");
		_UV_SOURCE__UV0 = mat.IsKeywordEnabled("_UV_SOURCE__UV0");
		_UV_SOURCE__WORLD_PLANAR_Y = mat.IsKeywordEnabled("_UV_SOURCE__WORLD_PLANAR_Y");
		_USE_VERTEX_COLOR = mat.IsKeywordEnabled("_USE_VERTEX_COLOR");
		_USE_WEATHER_MAP = mat.IsKeywordEnabled("_USE_WEATHER_MAP");
		_ALPHA_DETAIL_MAP = mat.IsKeywordEnabled("_ALPHA_DETAIL_MAP");
		_HALF_LAMBERT_TERM = mat.IsKeywordEnabled("_HALF_LAMBERT_TERM");
		_WATER_EFFECT = mat.IsKeywordEnabled("_WATER_EFFECT");
		_HEIGHT_BASED_WATER_EFFECT = mat.IsKeywordEnabled("_HEIGHT_BASED_WATER_EFFECT");
		_WATER_CAUSTICS = mat.IsKeywordEnabled("_WATER_CAUSTICS");
		_ALPHATEST_ON = mat.IsKeywordEnabled("_ALPHATEST_ON");
		_MAINTEX_ROTATE = mat.IsKeywordEnabled("_MAINTEX_ROTATE");
		_UV_WAVE_WARP = mat.IsKeywordEnabled("_UV_WAVE_WARP");
		_LIQUID_VOLUME = mat.IsKeywordEnabled("_LIQUID_VOLUME");
		_LIQUID_CONTAINER = mat.IsKeywordEnabled("_LIQUID_CONTAINER");
		_GT_RIM_LIGHT = mat.IsKeywordEnabled("_GT_RIM_LIGHT");
		_GT_RIM_LIGHT_FLAT = mat.IsKeywordEnabled("_GT_RIM_LIGHT_FLAT");
		_GT_RIM_LIGHT_USE_ALPHA = mat.IsKeywordEnabled("_GT_RIM_LIGHT_USE_ALPHA");
		_SPECULAR_HIGHLIGHT = mat.IsKeywordEnabled("_SPECULAR_HIGHLIGHT");
		_EMISSION = mat.IsKeywordEnabled("_EMISSION");
		_EMISSION_USE_UV_WAVE_WARP = mat.IsKeywordEnabled("_EMISSION_USE_UV_WAVE_WARP");
		_USE_DEFORM_MAP = mat.IsKeywordEnabled("_USE_DEFORM_MAP");
		_USE_DAY_NIGHT_LIGHTMAP = mat.IsKeywordEnabled("_USE_DAY_NIGHT_LIGHTMAP");
		_USE_TEX_ARRAY_ATLAS = mat.IsKeywordEnabled("_USE_TEX_ARRAY_ATLAS");
		_GT_BASE_MAP_ATLAS_SLICE_SOURCE__PROPERTY = mat.IsKeywordEnabled("_GT_BASE_MAP_ATLAS_SLICE_SOURCE__PROPERTY");
		_GT_BASE_MAP_ATLAS_SLICE_SOURCE__UV1_Z = mat.IsKeywordEnabled("_GT_BASE_MAP_ATLAS_SLICE_SOURCE__UV1_Z");
		_CRYSTAL_EFFECT = mat.IsKeywordEnabled("_CRYSTAL_EFFECT");
		_EYECOMP = mat.IsKeywordEnabled("_EYECOMP");
		_MOUTHCOMP = mat.IsKeywordEnabled("_MOUTHCOMP");
		_ALPHA_BLUE_LIVE_ON = mat.IsKeywordEnabled("_ALPHA_BLUE_LIVE_ON");
		_GRID_EFFECT = mat.IsKeywordEnabled("_GRID_EFFECT");
		_REFLECTIONS = mat.IsKeywordEnabled("_REFLECTIONS");
		_REFLECTIONS_BOX_PROJECT = mat.IsKeywordEnabled("_REFLECTIONS_BOX_PROJECT");
		_REFLECTIONS_MATCAP = mat.IsKeywordEnabled("_REFLECTIONS_MATCAP");
		_REFLECTIONS_MATCAP_PERSP_AWARE = mat.IsKeywordEnabled("_REFLECTIONS_MATCAP_PERSP_AWARE");
		_REFLECTIONS_ALBEDO_TINT = mat.IsKeywordEnabled("_REFLECTIONS_ALBEDO_TINT");
		_REFLECTIONS_USE_NORMAL_TEX = mat.IsKeywordEnabled("_REFLECTIONS_USE_NORMAL_TEX");
		_VERTEX_ROTATE = mat.IsKeywordEnabled("_VERTEX_ROTATE");
		_VERTEX_ANIM_FLAP = mat.IsKeywordEnabled("_VERTEX_ANIM_FLAP");
		_VERTEX_ANIM_WAVE = mat.IsKeywordEnabled("_VERTEX_ANIM_WAVE");
		_VERTEX_ANIM_WAVE_DEBUG = mat.IsKeywordEnabled("_VERTEX_ANIM_WAVE_DEBUG");
		_GRADIENT_MAP_ON = mat.IsKeywordEnabled("_GRADIENT_MAP_ON");
		_PARALLAX = mat.IsKeywordEnabled("_PARALLAX");
		_PARALLAX_AA = mat.IsKeywordEnabled("_PARALLAX_AA");
		_PARALLAX_PLANAR = mat.IsKeywordEnabled("_PARALLAX_PLANAR");
		_MASK_MAP_ON = mat.IsKeywordEnabled("_MASK_MAP_ON");
		_FX_LAVA_LAMP = mat.IsKeywordEnabled("_FX_LAVA_LAMP");
		_INNER_GLOW = mat.IsKeywordEnabled("_INNER_GLOW");
		_STEALTH_EFFECT = mat.IsKeywordEnabled("_STEALTH_EFFECT");
		_UV_SHIFT = mat.IsKeywordEnabled("_UV_SHIFT");
		_TEXEL_SNAP_UVS = mat.IsKeywordEnabled("_TEXEL_SNAP_UVS");
		_UNITY_EDIT_MODE = mat.IsKeywordEnabled("_UNITY_EDIT_MODE");
		_GT_EDITOR_TIME = mat.IsKeywordEnabled("_GT_EDITOR_TIME");
		_DEBUG_PAWN_DATA = mat.IsKeywordEnabled("_DEBUG_PAWN_DATA");
		_COLOR_GRADE_PROTANOMALY = mat.IsKeywordEnabled("_COLOR_GRADE_PROTANOMALY");
		_COLOR_GRADE_PROTANOPIA = mat.IsKeywordEnabled("_COLOR_GRADE_PROTANOPIA");
		_COLOR_GRADE_DEUTERANOMALY = mat.IsKeywordEnabled("_COLOR_GRADE_DEUTERANOMALY");
		_COLOR_GRADE_DEUTERANOPIA = mat.IsKeywordEnabled("_COLOR_GRADE_DEUTERANOPIA");
		_COLOR_GRADE_TRITANOMALY = mat.IsKeywordEnabled("_COLOR_GRADE_TRITANOMALY");
		_COLOR_GRADE_TRITANOPIA = mat.IsKeywordEnabled("_COLOR_GRADE_TRITANOPIA");
		_COLOR_GRADE_ACHROMATOMALY = mat.IsKeywordEnabled("_COLOR_GRADE_ACHROMATOMALY");
		_COLOR_GRADE_ACHROMATOPSIA = mat.IsKeywordEnabled("_COLOR_GRADE_ACHROMATOPSIA");
		LIGHTMAP_ON = mat.IsKeywordEnabled("LIGHTMAP_ON");
		DIRLIGHTMAP_COMBINED = mat.IsKeywordEnabled("DIRLIGHTMAP_COMBINED");
		INSTANCING_ON = mat.IsKeywordEnabled("INSTANCING_ON");
	}
